module ItemsHelper
  ...
  def getHistoryText (history)
    ...
    if history.action_type == "new"
      ...
      htmltext += "<td><font color='blue'><b>" + "Update on " + "</b></font></td><td><b>" + history.object_type + "</b> (id:" + history.object_id.to_s + ")</td><td>"
      htmltext += " changed " + history.field_name + " from " + history.old_value + " to " + history.value

    elsif history.action_type == "destroy"
      htmltext += "<td><font color='red'><b>" + "Deleted " + "</b></font></td><td><b>" + history.object_type + "</b> (id:" + history.object_id.to_s + ")</td><td>"
